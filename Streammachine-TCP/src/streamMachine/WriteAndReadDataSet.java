...
public class WriteAndReadDataSet {
	...
	public static void main(String[] args) throws IOException {
		...
		SensorDataSender sender = new SensorDataSender(new DataConnector("localhost", 7777));
		SensorDataReceiver receiver = new SensorDataReceiver(new DataConnector(7777),
				new StreamMachineFS("MyGoodOldSensor"));
