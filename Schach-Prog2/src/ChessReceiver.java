...
public interface ChessReceiver {
	...
	void receiveChoosenColor(boolean white) throws IOException, StatusException;

	/**
	 * Erlaubt im Zustand passiv. Führt zu aktiv. Setzt die Figur von der
	...
	/**
	 * Erlaubt im Zustand passiv. Führt zu aktiv. Setzt den Bauer von der
	 ...
	 * @throws StatusException
	 */
	void receiveMovePawnRule(int from, int figureType) throws IOException, StatusException;

	/**
	 * Erlaubt im Zustand passiv. Führt zu aktiv. Führt eine Rochade mit dem Turm
	...
	/**
	 * Erlaubt im Zustand passiv. Führt zu aktiv. Beendet das Spiel und schickt
	 * sendet den Grund dafür. 0 = checkmate 1 = stalemate 2 = abandon
	 * 
	 * @param reason
	 * @throws IOException
	 * @throws StatusException
	...
	/**
	 * Erlaubt im Zustand passiv. Führt zum Zustand aktiv. Spieler schlägt vor das
	 * Spiel zu beenden. 0 = draw 1 = end game
	 * 
	 * @param reason
	 * @throws IOException
	 * @throws StatusException
	...
	/**
	 * Erlaubt im Zustand Wartend. Führt zum Zustand true -> beendet false ->
